...
class Formatter {
    ...
    formatFileOperation(props) {
        switch (props.type) {
            ...
            case 'Libtool':
                return format('Building lib', formatBreadCrumb(props.fileName, props.target, props.project));
            case 'ProcessPCH':
                return format('Precompiling', formatBreadCrumb(props.fileName, props.target, props.project));
            case 'ProcessInfoPlistFile':
                return format('Processing', formatBreadCrumb(props.fileName, props.target, props.project));
            case 'CodeSign':
